...
import avatar from 'img/faces/face-1.jpg';
                                        ...
                                        <Row>
                                            <Col md={12}>
                                                <FormGroup controlId='formControlsTextarea'>
                                                    ...
                                                    <FormControl rows='5' componentClass='textarea' bsClass='form-control' placeholder='Here can be your description' defaultValue='Hello'/>
                                                </FormGroup>
                                            </Col>
                                        </Row>
                                        <Button
