...
let Dashboard = EmptyComponent, 
    UserProfile = EmptyComponent,
    TableList = EmptyComponent, 
    Typography = EmptyComponent,
    Icons = EmptyComponent,
    Maps = EmptyComponent,
    Notifications = EmptyComponent;

let Upgrade = EmptyComponent;

const appRoutes = [
    { path: "/dashboard", name: "Dashboard", icon: "pe-7s-graph", component: Dashboard },
    { path: "/user", name: "User Profile", icon: "p-e-7s-user", component: UserProfile },
