            ...
            if (status) {
              ...
              if (statusCode && statusCode[0].$.Value) {
                ...
                if (msgType != 'Success') {
                  ...
                  console.log("Error Statuscode: ", statusCode[0]);
				...
				console.log("Successful SAML Signin");
              }
            }
...
SAML.prototype.generateServiceProviderMetadata = function( decryptionCert ) {
  ...
  if (this.options.decryptionPvk) {
    ...
    metadata.EntityDescriptor.SPSSODescriptor.KeyDescriptor = {
      ...
      //   { 'EncryptionMethod': { '@Algorithm': 'http://www.w3.org/2001/04/xmlenc#aes256-cbc', '@KeySize': 'x' } },
      //   { 'EncryptionMethod': { '@Algorithm': 'http://www.w3.org/2001/04/xmlenc#aes128-cbc', '@KeySize': 'x' } },
      //   { 'EncryptionMethod': { '@Algorithm': 'http://www.w3.org/2001/04/xmlenc#tripledes-cbc', '@KeySize': 'x' } },
      // ]
    };
  }
